...
class Screen():
    ...
    def render(self, width, height, t, noiseList, palette):
        tosend = core.PixelMapper.render(width, height, t, self.pixelMapPacked, palette.packed, noiseList, self.dimmBy)
        for out in self.opcServers:
            out.putPixels(0, tosend)
